...
var getUser = (fastify2) => __async(void 0, null, function* () {
  fastify2.get("/users/:id", (request, reply) => __async(void 0, null, function* () {
...
var getUsers = (fastify2) => __async(void 0, null, function* () {
  fastify2.get("/users", (request, reply) => __async(void 0, null, function* () {
    try {
...
var updateUser = (fastify2) => __async(void 0, null, function* () {
  fastify2.put("/users/password/:id", (request, reply) => __async(void 0, null, function* () {
    const { id } = request.params;
...
var usersVerify = (fastify2) => __async(void 0, null, function* () {
  fastify2.post("/users/verify", (request, reply) => __async(void 0, null, function* () {
...
var signInUser = (fastify2) => __async(void 0, null, function* () {
  fastify2.post("/users/sign-in", (request, reply) => __async(void 0, null, function* () {
    const data = request.body;
    try {
      const user = yield db_default.users.findUnique({
        where: {
...
var signUpUser = (fastify2) => __async(void 0, null, function* () {
  fastify2.post("/users/sign-up", (request, reply) => __async(void 0, null, function* () {
    const data = request.body;
...
var userRoutes = (fastify2) => __async(void 0, null, function* () {
  fastify2.register(getUsers_default);
  fastify2.register(getUser_default);
  fastify2.register(signIn_default);
  fastify2.register(signUp_default);
  fastify2.register(usersVerify_default);
  fastify2.register(updateUser_default);
});
var users_default = userRoutes;

// src/routes/products/get/getProducts.ts
var getProducts = (fastify2) => __async(void 0, null, function* () {
  fastify2.get("/products", (request, reply) => __async(void 0, null, function* () {
    try {
...
var getProductsAdm = (fastify2) => __async(void 0, null, function* () {
  fastify2.get("/products/adm", (request, reply) => __async(void 0, null, function* () {
    try {
...
var getProduct = (fastify2) => __async(void 0, null, function* () {
  fastify2.get("/products/:id", (request, reply) => __async(void 0, null, function* () {
    const { id } = request.params;
    try {
...
var searchProducts = (fastify2) => __async(void 0, null, function* () {
  fastify2.get("/products/search/:query", (request, reply) => __async(void 0, null, function* () {
...
var createProduct = (fastify2) => __async(void 0, null, function* () {
  fastify2.post("/products", (request, reply) => __async(void 0, null, function* () {
    const data = request.body;
    try {
...
var productsRoutes = (fastify2) => __async(void 0, null, function* () {
  fastify2.register(getProducts_default);
  fastify2.register(getProductsAdm_default);
  fastify2.register(getProduct_default);
  fastify2.register(searchProducts_default);
  fastify2.register(post_default);
});
var products_default = productsRoutes;

// src/routes/statistics/get/getStatistics.ts
var getStatistics = (fastify2) => __async(void 0, null, function* () {
  fastify2.get("/statistics", (request, reply) => __async(void 0, null, function* () {
    try {
...
var statisticsRoutes = (fastify2) => __async(void 0, null, function* () {
  fastify2.register(getStatistics_default);
});
var statistics_default = statisticsRoutes;

// src/routes/orders/get/getOrderWithStatus.ts
var getOrderWithStatus = (fastify2) => __async(void 0, null, function* () {
  fastify2.get("/orders/:id/:status", (request, reply) => __async(void 0, null, function* () {
...
var createOrder = (fastify2) => __async(void 0, null, function* () {
  fastify2.post("/orders", (request, reply) => __async(void 0, null, function* () {
    const data = request.body;
    try {
...
var getItemsOrder = (fastify2) => __async(void 0, null, function* () {
  fastify2.get("/orders/items/:id", (request, reply) => __async(void 0, null, function* () {
    const { id } = request.params;
    try {
...
var getOrder = (fastify2) => __async(void 0, null, function* () {
  fastify2.get("/orders/:id", (request, reply) => __async(void 0, null, function* () {
    const { id } = request.params;
    try {
...
var getOrders = (fastify2) => __async(void 0, null, function* () {
  fastify2.get("/orders", (request, reply) => __async(void 0, null, function* () {
    try {
      const orders = yield db_default.$queryRawUnsafe(`
               SELECT * FROM orders
...
var ordersRoutes = (fastify2) => __async(void 0, null, function* () {
  fastify2.register(getOrder_default);
  fastify2.register(getOrders_default);
  fastify2.register(getOrderWithStatus_default);
  fastify2.register(getItemsOrder_default);
  fastify2.register(post_default2);
});
var orders_default = ordersRoutes;

// src/routes/paymentMethods/get/getPayments.ts
var getPayments = (fastify2) => __async(void 0, null, function* () {
  fastify2.get("/payments", (request, reply) => __async(void 0, null, function* () {
    try {
...
var createPayment = (fastify2) => __async(void 0, null, function* () {
  fastify2.post("/payments", (request, reply) => __async(void 0, null, function* () {
    const data = request.body;
    try {
...
var paymentMethodsRoutes = (fastify2) => __async(void 0, null, function* () {
  fastify2.register(getPayments_default);
  fastify2.register(createPayment_default);
});
...
var uploadPostRoute = (fastify2) => __async(void 0, null, function* () {
  fastify2.post("/upload", (request, reply) => __async(void 0, null, function* () {
...
var registerRoutes = (app2) => {
  app2.register(orders_default);
  app2.register(post_default3);
  app2.register(products_default);
  app2.register(statistics_default);
  app2.register(users_default);
  app2.register(paymentMethods_default);
};

// src/app.ts
var buildApp = () => {
  const app2 = (0, import_fastify.default)();
  registerPlugins(app2);
  registerRoutes(app2);
  return app2;
};
